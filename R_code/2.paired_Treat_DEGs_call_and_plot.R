...
Day20_target_genes <- c("Mmp3", "Mmp9", "Mmp10", "Mmp12", "Mmp13", "Igf2bp3", "Rasgrf2", "Mapk7", "Fgfbp1", "Traf1", "Igf2", "Map3k2", "Kras", "Fgfr2", "Fgfr4", "Mras", "Map3k12", "Map4k1",  "Fgf7", "Map4k2", "Mapk1", "Map4k11", "Dusp2", "Rasgrp1",  "Mapk13", "Map4k4", "Map3k3", "Map3k20", "Rasgrp3", "Rps6ka5", "Mapkapk3", "Mapk9", "Fgf1", "Mapk11", "Fgfr3" )
...
target_genes<-c("Mmp12", "Mmp10", "Mmp3", "Mmp13", "Mmp7", "Mmp11", "Mmp20", "Mmp19", "Mmp2", "Mmp9", "Mmp14", "Mmp23", "Fgf11", "Fgfr2", "Fgfr4", "Fgf7", "Fgf16", "Fgfr3", "Igf2", "Igfbp3", "Igfbp5", ",gfbp2", "Igf2bp2", "Igfbp4", "Mapk7", "Mapk13", "Mapk8ip3", "Mapkapk3", "Mapk9", "Mapk6", "Mapk11", "Traf1", "Kras", "Mras", "Dusp2", "Rasgrp1", "Rasgrf2", "Rasgrp3")
...
for(Day_tag in c("D3","D7","D20")){
  ...
  colData_day<-colData[which(colData$Day == Day_tag),]
  colData_day<-colData_day[order(colData_day$pair_id,colData_day$Treat,decreasing = F),c("pair_id","Treat")]
  colData_day$pair_id<-factor(colData_day$pair_id,levels = unique(as.character(colData_day$pair_id)))
  expression_matrix1<-expression_matrix0[,rownames(colData_day)]
  
  dds0 <- DESeqDataSetFromMatrix(countData = expression_matrix1, colData = colData_day, design = ~ pair_id+Treat)
  #data pre_cleaning
  dds1 <- dds0[ rowSums(counts(dds0)) > 1, ]
  ...
  ggsave(file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/PCA_rld_Treat_text_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,".pdf"),plot_PCA13,width = 10, height =5)
  ...
  pdf(file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/pearson_cluster_Treat_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,".pdf"),width = 10, height =6)
  ...
  pdf(file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/distance_heatmap_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,".pdf"),width = 10, height =9)
  print(heat_plot)
  dev.off()
  ...
  ggsave(paste0("/share/home/chenwei/LZJ_SCARE/intergroup/PCA_1_2_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,".pdf"),plot_PCA3,width=10, height=5)
  ...
  ggsave(paste0("/share/home/chenwei/LZJ_SCARE/intergroup/PCA_2_3_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,".pdf"),plot_PCA23,width=10, height=5)
  ...
  ggsave(paste0("/share/home/chenwei/LZJ_SCARE/intergroup/PCA_1_3_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,".pdf"),plot_PCA13,width=10, height=5)
  ...
  file <- paste0("/share/home/chenwei/LZJ_SCARE/intergroup/file2_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,".log2_normalized_count_add_gene_information.txt")
  ...
  file <- paste0("/share/home/chenwei/LZJ_SCARE/intergroup/file3_paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,".DEG_information_pvalue005_FC1.5.txt")
  ...
  plot_vocano
  ggsave(plot_vocano,file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_vocano_DEGs.pdf"), width = 8, height = 8)
  ggsave(plot_vocano,file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_vocano_DEGs.png"), width = 8, height = 8)
  ...
  plot_vocano2
  ggsave(plot_vocano2,file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_vocano_DEGs_notext.pdf"), width = 8, height = 8)
  ggsave(plot_vocano2,file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_vocano_DEGs_notext.png"), width = 8, height = 8)
  ...
  ggsave(plot_vocano3,file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_vocano_DEGs_lable.pdf"), width = 8, height = 8)
  ggsave(plot_vocano3,file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_vocano_DEGs_lable.png"), width = 8, height = 8)
  ...
  A_list<-rownames(colData_day[which(colData_day$Treat == sampleA),])
  B_list<-rownames(colData_day[which(colData_day$Treat == sampleB),])
  ...
  pdf(file=paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_heatmap_",Treat_group,"_",Day_tag,"_",Treat_tag,"_",sampleA,"_vs_",sampleB,"_DEGs_p005_FC1.5.pdf"),width = 7, height =7)
  print(heat_plot)
  dev.off()
}
...
pdf(paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_heatmap_",Treat_group,"_",Treat_tag,"_venn_three_lists_DEGs.pdf"),width = 8,height=8)
grid.newpage(); 
grid.draw(venn1)
grid.newpage();
grid.draw(venn2)
...
pdf(paste0("/share/home/chenwei/LZJ_SCARE/intergroup/paired_",Treat_group,"_",Treat_tag,"_two_group_upsetplot_six_lists_interDay_DEGs.pdf"),width = 10,height=8)
